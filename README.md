...
<!--
**Abubakar-Meigag/Abubakar-Meigag** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
<!-- GitHub Profile README — Abubakar M. Meigag -->
...
| **OpenVPN Infrastructure** — Self-healing VPN on AWS; 80% faster deployments via Ansible, zero-downtime via Lambda + Auto Scaling | `Terraform` `Ansible` `AWS` `Python` | Private |
